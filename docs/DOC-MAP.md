...
| ---------------------------------------------------- | --------------------------------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dev-master-design-20260509-083149.md`               | Alarm reactions (storm + look-at-table) | LOOK-AT-TABLE SHIPPED 2026-06-12            | Look-at-table half live (alarm replaces sus-4 GameOver; check vs stash; settle to baseline 1). Storm + the 70/30 weights roll pend storm art. Implementation note in doc body records the as-built deviations (R4 caveat triggered, R5 via public endLevel, no reaction track yet).         |
