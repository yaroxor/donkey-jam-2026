...
export class MainGame extends Scene
{
    ...
    {
        // Static block (sword) keep-out: 60x161 native, rotated 90 degrees -> 161x60.
    ...
    //   - a dizzy-stars emoji ABOVE the hand (y - 60) -- scale-pulses for liveness
    ...
    //   t=350  bottom of fall (~100px below cell, ~35 degrees tumble) -- Cubic easeIn
    ...
    // fall duration (250), tumble angle (35 degrees), fade delay (250), fade
    // duration (200).
